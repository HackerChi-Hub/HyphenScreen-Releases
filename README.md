...
**当前版本：[黑粉录屏 0.4.47 · 预览版](https://github.com/HackerChi-Hub/HyphenScreen-Releases/releases/tag/v0.4.47)**（预览版：功能可用，仍在实测中；每个平台只保留最新的一版）。

> 0.4.47 目前提供 macOS 安装包；Windows 继续提供 [黑粉录屏 0.4.36 · 预览版](https://github.com/HackerChi-Hub/HyphenScreen-Releases/releases/tag/v0.4.36)，尚未发布 0.4.47 的 Windows 版；Linux 继续提供 [黑粉录屏 0.4.36 · 预览版](https://github.com/HackerChi-Hub/HyphenScreen-Releases/releases/tag/v0.4.36)，尚未发布 0.4.47 的 Linux 版。
...
| 平台 | 文件 | SHA-256 |
|---|---|---|
| macOS 13+（Apple 芯片 arm64） | `HyphenScreen_0.4.47_arm64.dmg` | `799f9fd2a6f774e8f16399b69c02978744caeb8655fecbf93dee4b0329f7420a` |
...
> 下面的功能一览按 0.4.47 介绍；Windows 暂为 0.4.36，不包含之后加入的功能；Linux 暂为 0.4.36，不包含之后加入的功能，各版变化见发行页面上的发行说明。
