...
**当前版本：[黑粉录屏 0.4.36 · 预览版](https://github.com/HackerChi-Hub/HyphenScreen-Releases/releases/tag/v0.4.36)**（预览版：功能可用，仍在实测中；每个平台只保留最新的一版）。

> 0.4.36 目前提供 Windows、Linux 安装包；macOS 继续提供 [黑粉录屏 0.4.35 · 预览版](https://github.com/HackerChi-Hub/HyphenScreen-Releases/releases/tag/v0.4.35)，尚未发布 0.4.36 的 macOS 版。
...
| 平台 | 文件 | SHA-256 |
|---|---|---|
| Windows 10/11（x64） | `HyphenScreen_0.4.36_x64-setup.exe` | `3083ebe54d5971ae3ba3dc3570b13cf2308574872b19023d628b054f1bfbcad5` |
| Linux（x86_64） | `HyphenScreen_0.4.36_x86_64.AppImage` | `137ab42c10c7c7ef72e031bc7061d7bee7f7d21a652d45ba4c3d4652f519eb5b` |
| Debian / Ubuntu（amd64） | `HyphenScreen_0.4.36_amd64.deb` | `7adbf36462d12ad95f6982d2869f59505de3c22093ccf9af670a3408a4940b44` |
| Arch Linux（x86_64） | `HyphenScreen_0.4.36_x64.pacman` | `b81caf0ddcfd14b7cc9bf5bc16b89f1df65a1852e4df639e11ce57a58e13332f` |
| macOS 13+（Apple 芯片 arm64）· 0.4.35 版 | `HyphenScreen_0.4.35_arm64.dmg` | `d41f322ec1ad1259a527ef8f9a93ac8f398b83328b56cca9591fcba65f1b1a8f` |

同一页附带各平台的 `SHA256SUMS*.txt` 与 `release-manifest.json`，可核对文件完整性与构建来源。

> 下面的功能一览按 0.4.36 介绍；macOS 暂为 0.4.35，不包含之后加入的功能，各版变化见发行页面上的发行说明。
